...
The project has been forked from the alt beacon library reference app. In this forked version: 

- We are reading iBeacons instead of Alt beacons
- Showing the data from all the beacons that the device is seeing
- Logging the data 
